...
ARCHITECTURE structure OF MSpecialCount IS
...
SIGNAL \inst|sub|137~combout\ : std_logic;
...
-- Equation(s):
-- \inst|sub|68~combout\ = (!\inst|sub|34~q\ & (((!\inst|sub|122~q\ & \M~input_o\)) # (!\inst|sub|134~q\)))
...
-- Equation(s):
-- \inst4~0_combout\ = (\inst|sub|134~q\ & ((\inst|sub|122~q\) # (!\M~input_o\)))
...
-- Equation(s):
-- \inst|sub|115~combout\ = (!\inst4~0_combout\ & (\inst|sub|111~q\ $ (\inst|sub|34~q\)))
...
-- Equation(s):
-- \inst|sub|126~combout\ = (!\inst4~0_combout\ & (\inst|sub|122~q\ $ (((\inst|sub|111~q\ & \inst|sub|34~q\)))))
...
-- Equation(s):
-- \inst|sub|131~combout\ = \inst|sub|134~q\ $ (((\inst|sub|122~q\ & (\inst|sub|111~q\ & \inst|sub|34~q\))))
...
\inst|sub|137\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|sub|137~combout\ = (\inst|sub|131~combout\ & (((!\inst|sub|122~q\ & \M~input_o\)) # (!\inst|sub|134~q\)))
