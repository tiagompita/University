...
-- pragma translate_on
PORT MAP (
	i => \inst7|ALT_INV_Mux3~0_combout\,
	devoe => ww_devoe,
	o => \HEX0[3]~output_o\);
...
-- Equation(s):
-- \inst7|Mux0~0_combout\ = (\SW[1]~input_o\) # (\SW[0]~input_o\)
...
-- Equation(s):
-- \inst7|Mux1~0_combout\ = (!\SW[0]~input_o\) # (!\SW[1]~input_o\)
...
-- Equation(s):
-- \inst7|Mux2~0_combout\ = (\SW[1]~input_o\) # (!\SW[0]~input_o\)
...
-- Equation(s):
-- \inst7|Mux3~0_combout\ = \SW[1]~input_o\ $ (\SW[0]~input_o\)
...
\inst7|Mux1~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst7|Mux1~1_combout\ = (!\SW[1]~input_o\ & \SW[0]~input_o\)
