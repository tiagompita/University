...
int main() {
  ...
  const unsigned minSheepWt{80};   // Minimum weight of a sheep in pounds
  const unsigned maxSheepWt{150};  // Maximum weight of a sheep in pounds
  const unsigned minCowWt{800};    // Minimum weight of a cow in pounds
  const unsigned maxCowWt{1500};   // Maximum weight of a cow in pounds
